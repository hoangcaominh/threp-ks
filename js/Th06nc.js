...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Th06nc = factory(root.KaitaiStream);
  }
}(typeof self !== 'undefined' ? self : this, function (KaitaiStream) {
var Th06nc = (function() {
  function Th06nc(_io, _parent, _root) {
    this._io = _io;
  ...
  Th06nc.prototype._read = function() {
  ...
  var Dummy = Th06nc.Dummy = (function() {
  ...
  var Header = Th06nc.Header = (function() {
    ...
    Header.prototype._read = function() {
      ...
      this.stageOffsets = [];
      for (var i = 0; i < 7; i++) {
        this.stageOffsets.push(this._io.readU8le());
      }
    }
  ...
  var Stage = Th06nc.Stage = (function() {
  ...
  Object.defineProperty(Th06nc.prototype, 'stages', {
    get: function() {
